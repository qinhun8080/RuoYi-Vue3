  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="用户学历" prop="education">
        <el-select v-model="queryParams.education" placeholder="请选择用户学历" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户学历" align="center" prop="education">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="userRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="用户学历" prop="education">
          <el-select v-model="form.education" placeholder="请选择用户学历">
            <el-option
              v-for="dict in user_edu"
              :key="dict.value"
              :label="dict.label"
